...
const Navbar = () => {
    ...
    return (
        <div className="navbar bg-base-100 shadow-lg px-4 lg:px-10 py-4 lg:py-6 w-full fixed z-10">
            <div className="navbar-start">
                <div className="dropdown">
                    <div tabIndex="0" role="button" className="btn btn-ghost lg:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                    </div>
                    <ul tabIndex="0" className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 text-base font-bold gap-2">
                ...
                <Link to="/" className="btn btn-ghost font-bold text-3xl text-primary gap-0">Blog
                <span className="text-secondary">Blast</span></Link>
            </div>
            <div className="navbar-end flex gap-3">
                <ul className="menu menu-horizontal px-1 text-base font-bold gap-6 items-center hidden lg:flex">                    
                    <NavLink to="/" className={({isActive}) => isActive? "text-primary" : ""}>Home</NavLink>
                    <NavLink to="/blogs" className={({isActive}) => isActive? "text-primary" : ""}>Blogs</NavLink>
                    <NavLink to="/bookmarks" className={({isActive}) => isActive? "text-primary" : ""}>Bookmarks</NavLink>
                </ul>
